...
<script type="text/javascript" src="<?php bloginfo('template_url'); ?>/includes/syntaxhighlighter/scripts/shCore.js"></script>
<script type="text/javascript" src="<?php bloginfo('template_url'); ?>/includes/syntaxhighlighter/scripts/shBrushCpp.js"></script>
<script type="text/javascript" src="<?php bloginfo('template_url'); ?>/includes/syntaxhighlighter/scripts/shBrushPhp.js"></script>
<link type="text/css" rel="stylesheet" href="<?php bloginfo('template_url'); ?>/includes/syntaxhighlighter/styles/shCoreFadeToGrey.css"/>
...
<body>
    ...
    <header class="left">
    	...
    	<div class="sns-icon">
        	<ul>
				<li class="wider-switch"><i class="fa fa-expand"></i><span>隐藏侧栏</span></li>
